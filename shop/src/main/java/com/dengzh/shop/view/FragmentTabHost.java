...
/**
 * Created by loovee on 2017/2/20.
 * 解决官方FragmentTabHost 每次切换 会重新绘制UI问题
 */
...
//					ft.detach(tab.fragment);
        ...
        if (ft != null) {
            ft.commitAllowingStateLoss();//解决java.lang.IllegalStateException: Can not perform this action after onSaveInstanceState
