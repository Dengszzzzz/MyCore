...
import com.dengzh.shop.module.BaseFragment;
...
public class ShopHomeFragment extends BaseFragment implements View.OnClickListener{
    ...
    private void addHeadView() {
        View headrView = LayoutInflater.from(mActivity).inflate(R.layout.shop_view_shop_home_header, null);
        ...
        homeBannerAdapter = new HomeBannerAdapter(mActivity);
        viewPager.setAdapter(homeBannerAdapter);
        viewPager.setHintView(new ColorPointHintView(mActivity, Color.WHITE, Color.parseColor("#40ffffff")));
        //分类
        classifyRv.setHasFixedSize(true);
        classifyRv.setLayoutManager(new FullyGridLayoutManager(mActivity,3));
        ...
        recommendRv.setLayoutManager(new FullyGridLayoutManager(mActivity,2));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        LogUtil.e("fragment","ShopHomeonCreateView()");
