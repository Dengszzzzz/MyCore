...
public class GestureLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        leftDrawableId = typedArray.getResourceId(R.styleable.GestureLayout_leftDrawable, R.mipmap.ic_launcher);
        rightDrawableId = typedArray.getResourceId(R.styleable.GestureLayout_rightDrawable, R.mipmap.ic_launcher);
        bottomDrawableId = typedArray.getResourceId(R.styleable.GestureLayout_bottomDrawable, R.mipmap.ic_launcher);
        typedArray.recycle();
        mLeftPos = new Point();
        mRightPos = new Point();
        mHomePos = new Point();
