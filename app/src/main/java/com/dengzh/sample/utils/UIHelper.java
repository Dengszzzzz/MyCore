...
public class UIHelper {
    ...
    public static int getDimension(@DimenRes int dimenRes) {
        return (int) App.ctx.getResources().getDimension(dimenRes);
    }
    ...
    public static int getColor(@ColorRes int color) {
        return ContextCompat.getColor(App.ctx, color);
    }
    ...
    public static Drawable getDrawable(int drawable) {
        return ContextCompat.getDrawable(App.ctx, drawable);
    }
    ...
    public static void clipContent(String content) {
        ClipboardManager cm = (ClipboardManager) App.ctx.getSystemService(Context.CLIPBOARD_SERVICE);
